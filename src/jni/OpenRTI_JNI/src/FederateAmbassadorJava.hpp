...
#ifndef FEDERATEAMBASSADORJAVA_HPP_
#define FEDERATEAMBASSADORJAVA_HPP_
...
class FederateAmbassadorJava : public FederateAmbassador
{
public:
FederateAmbassadorJava (JNIEnv *env, const jobject& object )
	 throw (
		FederateInternalError);

  virtual ~FederateAmbassadorJava ()
	 throw () {}

private:
  	jobject createJavaTime(const LogicalTime& theTime) const;
	jobject _object;
	JNIEnv *_env;
	jclass _class;

	jmethodID callback_timeAdvanceGrant;
	jmethodID callback_timeRegulationEnabled;
	jmethodID callback_timeConstrainedEnabled;

	jmethodID callback_discoverObjectInstance_3;
	jmethodID callback_discoverObjectInstance_4;

	jmethodID callback_removeObjectInstance_4;
	jmethodID callback_removeObjectInstance_6;
	jmethodID callback_removeObjectInstance_7;

	jmethodID callback_reflectAttributeValues_6;
	jmethodID callback_reflectAttributeValues_8;
	jmethodID callback_reflectAttributeValues_9;

	jmethodID callback_receiveInteraction_6;
	jmethodID callback_receiveInteraction_8;
	jmethodID callback_receiveInteraction_9;

	jmethodID callback_connectionLost;
...
#endif /* FEDERATEAMBASSADORJAVA_HPP_ */
